...
// Lusaka, Zambia coordinates and known locations
const LUSAKA_CENTER = { lat: -15.4167, lng: 28.2833 };

const KNOWN_LOCATIONS = [
  { name: "Cairo Road", lat: -15.4142, lng: 28.2809 },
  { name: "Manda Hill", lat: -15.3975, lng: 28.3072 },
  { name: "University Teaching Hospital", lat: -15.4391, lng: 28.2856 },
  { name: "Lusaka Central Police", lat: -15.4186, lng: 28.2817 },
  { name: "Levy Junction", lat: -15.4089, lng: 28.3189 },
  { name: "Kamwala Shopping Centre", lat: -15.4328, lng: 28.2894 },
  { name: "Arcades Shopping Mall", lat: -15.3942, lng: 28.3122 },
  { name: "East Park Mall", lat: -15.3867, lng: 28.3228 },
  { name: "Intercity Bus Terminus", lat: -15.4253, lng: 28.2836 },
  { name: "Woodlands Stadium", lat: -15.4506, lng: 28.3167 }
];

// Generate mock SOS alerts near Lusaka
const generateMockSOSAlerts = () => {
  ...
  return [
    {
      ...
      information: 'Armed robbery in progress near shop',
      status: 'active',
      priority: 'high',
    ...
    {
      id: 'sos-002',
      madeBy: 'user-premium-002',
      userName: 'Mary Mwale',
      contact: '+260 96 7654321',
      location: { latitude: -15.3975, longitude: 28.3072 },
      locationName: "Manda Hill",
      information: 'Medical emergency - person collapsed',
      status: 'responding',
      priority: 'high',
    ...
    {
      id: 'sos-003',
      madeBy: 'user-premium-003',
      userName: 'David Phiri',
      contact: '+260 95 2468135',
      location: { latitude: -15.4089, longitude: 28.3189 },
      locationName: "Levy Junction",
      information: 'Car accident, two vehicles involved',
      status: 'active',
      priority: 'medium',
    ...
    {
      id: 'sos-004',
      madeBy: 'user-premium-004',
      userName: 'Grace Tembo',
      contact: '+260 97 8529637',
      location: { latitude: -15.4328, longitude: 28.2894 },
      locationName: "Kamwala Shopping Centre",
      information: 'Suspicious person following me',
      status: 'resolved',
      priority: 'medium',
    ...
    {
      id: 'sos-005',
      madeBy: 'user-premium-005',
      userName: 'Peter Lungu',
      contact: '+260 96 1472583',
      location: { latitude: -15.3942, longitude: 28.3122 },
      locationName: "Arcades Shopping Mall",
      information: 'Fire alarm activated in building',
      status: 'resolved',
      priority: 'high',
